...
# set wfpdir = /iraf/extern/WFpackage/
#                                 NB.^
...
print ("     *****************************************************************")
print ("     **                WELCOME IN THE WFPRED PACKAGE                **")
print ("     **                                                             **")
print ("     **                Version 2.0alpha January 2008                **")
print ("     **                                                             **")
...
task 	wfpskysub	= "wfpddir$wfpskysub.cl"
task 	wcsextract	= "wfpddir$wcsextract.cl"
