...
int	sampx=100	{prompt = "Number of x sampling points ?"}
int     sampy=200	{prompt = "Number of y sampling points ?"}
pset	ccmap		{prompt = "ccmap: Edit parameters"}
...
#- EVH: for the WFI we used the following:
	...
	ccmap.refsystem = "INDEF"
	ccmap.fitgeometry = "general"
	ccmap.function = "polynomial"
	ccmap.xxorder = 4
	ccmap.xyorder = 4
	ccmap.xxterms = "full"
	ccmap.yxorder = 4
	...
	ccmap(coordinates, _out, solution=extname, images="", results="", 
		...
		lngrefu="deg", latrefu="deg", project="tnx", update-)
